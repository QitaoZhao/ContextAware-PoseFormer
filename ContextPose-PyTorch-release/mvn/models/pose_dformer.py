...
class DeformableBlock(nn.Module):
    ...
    def forward(self, x, ref, features_list):
        ...
        return x, pos, weights.view(b, l, p, -1, 1)
...
class PoseTransformer(nn.Module):
    ...
    def forward(self, keypoints_2d, ref, features_list):
        ...
        # x = torch.stack(features_ref_list, dim=1) # [b, 5, p, c]
        ...
        for blk in self.context_blocks:
            x, offsets, weights = blk(x, ref, features_list)
            # # print(offsets[0])
            # offsets[..., :2] = offsets[..., :2] + 1
            # offsets[..., :2] *= torch.tensor([192//2, 256//2], device=x.device)
        ...
        return x#, list_offsets, list_weights
