...
from mvn.models.pose_dformer_b import PoseTransformer
...
class VNet(nn.Module):
    def __init__(self, config, device='cuda:0'):
        ...
        # self.poseformer = PoseTransformer(config.model.poseformer)
    ...
    def forward(self, images, keypoints_2d_cpn, keypoints_2d_cpn_crop):
        ...
        keypoints_3d = self.volume_net(keypoints_2d_cpn, keypoints_2d_cpn_crop, [])
