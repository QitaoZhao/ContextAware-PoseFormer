...
class globalNet(nn.Module):
    ...
    def forward(self, x):
        ...
        for i in range(len(self.channel_settings)):
            ...
            # 0 torch.Size([512, 256, 8, 6])
            # 0 torch.Size([512, 17, 64, 48])
            # 1 torch.Size([512, 256, 16, 12])
            # 1 torch.Size([512, 17, 64, 48])
            # 2 torch.Size([512, 256, 32, 24])
            # 2 torch.Size([512, 17, 64, 48])
            # 3 torch.Size([512, 256, 64, 48])
            # 3 torch.Size([512, 17, 64, 48])
