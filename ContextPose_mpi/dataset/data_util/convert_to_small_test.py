...
for sub in subject_list:
	...
	print(sub)
	fileformat = os.path.join('dataset/mpi_inf_3dhp_test_set', sub, 'imageSequence', 'img_{:06d}.jpg')

	target_dir = "dataset/mpi_inf_3dhp_test_set/images/" + sub
	target_path = os.path.join(target_dir, sub + '_{:06d}.jpg')
	...
	for i in tqdm(range(valid_frame)):
		...
		# os.remove(file_path)
		retval = cv2.imwrite(target_path.format(i+1), data_numpy)
